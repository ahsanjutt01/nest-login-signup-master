...
import { ApiTags, ApiProperty, ApiOkResponse, ApiBody, ApiParam } from '@nestjs/swagger';
...
export class OrdersController {
    ...
    constructor(private orderService: OrdersService, private spacesService: SpacesService) { }
    ...
    async saveAssetsToSpaces(@Body() assets: S3AssetsDto[]) {
        return await this.spacesService.uploadFileToBucket(process.env.S3_DB_SPACE, "backup-123uuid.txt", "Body here");
    }
